...
![Image Alt text](images/Mulukutla_S_Sarma_Introduction_to_Electrical_Eng.png "Mulukutla S Sarma Introduction to Electrical Engineering")
...
## Word Nibble Byte Bit

> At a **Word** from the master, we`d **Nibble** those tasty **Bytes** from the restaurant in **Bits**.
>
> *Newton*
